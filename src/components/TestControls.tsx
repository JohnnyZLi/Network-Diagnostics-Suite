      ...
      >
        <div className="data-confirmation-dialog__content jl-dialog__surface">
          ...
          <p className="jl-dialog__message" id="data-confirmation-dialog-description">
            The {TRANSFER_MODES[transferMode].name.toLowerCase()} method may transfer up to {formatBytes(transferCap)}. Avoid running it on metered or cellular connections.
          </p>
